module.exports = ({
    name: "pussylick",
    code: `
  $description[1;<@$authorID> le hasta lamiendo el coño de  <@$mentioned[1;yes]>]
$color[1;RANDOM]
$image[1;$get[nsfw]]
$djsEval[const { nsfw} = require('nsfw-muichiro');

(async() => {
const pack = await nsfw('pussylick');
d.vars['nsfw'] = pack.link;
d.data.vars = d.vars
})()]

$onlyIf[$mentioned[1]!=$authorID;No te puedes lamer tu propio coño! <:6739_panda_bruh:995801182956167249>]
